...
router.get("/auth/resetpassword", (req, res) => {
  ...
  // let curTimeVal = currentTime.getTime();
  let strTime = currentTime.getTime().toString();
  ...
  con.query(
    ...
    (error, result) => {
      ...
      if (error) {
        ...
        console.log(results.tokenValue === tokenValue);
        console.log(results.expiredAt >= strTime);
